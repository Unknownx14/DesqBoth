...
public class E2E07 extends BaseTest03 {
	...
	//Here we use a simple DataProvider for a small amount of data we want to send
		...
		public Object[][] getData() throws IOException
		{
			...
			List<HashMap<String, String>> data = getJsonDataToHashMap(System.getProperty("user.dir") + "\\src\\test\\java\\Academy\\Data\\SubmitCancelReservation.json");
